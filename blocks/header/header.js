...
//   document.querySelector('.nav-wrapper .default-content-wrapper')?.classList.add('nav-wrapper__content');
//   const contentWrapper = document.querySelector('.nav-wrapper__content');
